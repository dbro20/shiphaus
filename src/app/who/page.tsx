export default function Who() {
  const attendees = [
    ...
    { name: "Dylan", initial: "D", color: "var(--accent-red)", description: "No longer code inept, just happy the slop code works" },
    { name: "Eden", initial: "E", color: "var(--accent-blue)", description: "Talented google engineer, trying to exit wagie status" },
    { name: "Greg", initial: "G", color: "var(--accent-yellow)", description: "Newly entered boomer status by wearing sweaters" },
  ];
